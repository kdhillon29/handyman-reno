      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 px-3 gap-2 md:gap-4 mb-2">
          ...
          <p className="text-clamp text-slate-700 p-2 md:p-3 leading-6 tracking-tight text-justify">
            We are here to provide you full residential and commercial building maintenance services
            in reasonable price. we have the skills and experience to deliver high-quality results.
            We take the time to understand your needs and deliver the best results.
            <br />
            <br />
            Our tasks include all types of building maintaince work, framing, cladding, maintaince
            work both interior and exterior, tiling, regrout, wall painting and gyprock
            installation.
          </p>
        </div>
