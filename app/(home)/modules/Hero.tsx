...
const Hero = () => {
  return (
    <div className=" relative w-full h-[60vh] md:h-[90vh]  mt-0 overflow-hidden ">
      <HeroCarousel />
      <div
        className="relative z-10 ps-3 py-4 md:pt-24 flex flex-col items-start 
         ...
         "
            ...
            <div className="flex flex-col  mt-1 gap-5">
              <div className="flex items-center gap-[.5]">
                ...
                <h2
            className=" md:max-w-2xl   text-xl md:text-2xl tracking-wide
          ...
          >
            ...
            <span className=" font-bold text-primary "> PRECISION</span>
              ...
              <p className=" text-sm md:text-ms  text-green-500 font-bold">
          ...
          <p
            className=" text-blue-100/90 w-2/3 mt-7 text-justify hidden md:block  font-semibold md:max-w-2xl  leading-6 tracking-tight
          ...
          >
            ...
            tailored to your specific needs and budget. With over 8 years of industry experience, we
            have built a reputation for reliability and trust, serving over 100 satisfied clients.
          </p>
          <Button />
        </div>
        <div>
