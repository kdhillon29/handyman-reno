  ...
  return (
    <nav
      className="container mx-auto px-4 fixed top-0 left-0 right-0 flex justify-between
              items-center h-16 bg-white/70 md:hidden z-50"
    >
      <Logo/>
      ...
      <div className={`fixed bg-blend-luminosity top-16 backdrop-blur-md transition-all delay-75 duration-500 h-screen
